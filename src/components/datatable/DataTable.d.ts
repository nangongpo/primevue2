...
declare class DataTable extends Vue {
  ...
  $emit(
    eventName: 'row-click',
    event: { originalEvent: Event; data: any; index: number }
  ): this
  $emit(
  ...
  $emit(
    eventName: 'row-select-all',
    event: { originalEvent: Event; data: any }
  ): this
  ...
  $emit(
    eventName: 'column-resize-end',
    event: { originalEvent: Event; delta: any }
  ): this
  $emit(
  ...
  $emit(
    eventName: 'rowgroup-expand',
    event: { originalEvent: Event; data: any[] }
  ): this
  $emit(
    eventName: 'rowgroup-collapse',
    event: { originalEvent: Event; data: any[] }
  ): this
