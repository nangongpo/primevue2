...
export default {
    ...
    extends: BaseListbox,
    inheritAttrs: false,
    emits: ['input', 'change', 'focus', 'blur', 'filter'],
    list: null,
    ...
    methods: {
        ...
        onOptionSelectMultiple(event, option) {
            ...
            if (metaSelection) {
                ...
                value = selected ? this.removeOption(option) : [...(this.value || []), this.getOptionValue(option)];
            }
        ...
        isSelected(option) {
            ...
            if (this.multiple) return (this.value || []).some((value) => this.isEquals(value, optionValue));
            else return this.isEquals(this.value, optionValue);
        },
