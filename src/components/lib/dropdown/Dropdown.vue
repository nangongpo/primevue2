...
import BlankIcon from 'primevue2/icons/blank';
...
export default {
    ...
    inheritAttrs: false,
    emits: ['input', 'change', 'focus', 'blur', 'before-show', 'before-hide', 'show', 'hide', 'filter'],
    ...
    methods: {
        ...
        isSelected(option) {
            return this.isValidOption(option) && ObjectUtils.equals(this.value, this.getOptionValue(option), this.equalityKey);
        },
    ...
    computed: {
        ...
        editableInputValue() {
            ...
            return selectedOptionIndex !== -1 ? this.getOptionLabel(this.visibleOptions[selectedOptionIndex]) : this.value || '';
        },
        equalityKey() {
