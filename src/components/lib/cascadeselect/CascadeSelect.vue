...
export default {
    ...
    inheritAttrs: false,
    emits: ['input', 'change', 'focus', 'blur', 'click', 'group-change', 'before-show', 'before-hide', 'hide', 'show'],
    ...
    methods: {
        ...
        show(isFocus) {
            ...
            this.activeOptionPath = this.hasSelectedOption ? this.findOptionPathByValue(this.value) : this.activeOptionPath;
    ...
    computed: {
        ...
        label() {
            ...
            if (this.hasSelectedOption) {
                const activeOptionPath = this.findOptionPathByValue(this.value);
