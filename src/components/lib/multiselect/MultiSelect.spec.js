...
describe('MultiSelect.vue', () => {
    ...
    it('should select an item', async () => {
        ...
        expect(wrapper.emitted()['input'][0]).toEqual([[wrapper.vm.options[0]]]);

        await wrapper.setProps({ value: [wrapper.vm.options[0]] });
        await wrapper.vm.onContainerClick();
    ...
    it('should select multiple item', async () => {
        ...
        expect(wrapper.emitted()['input'][0]).toEqual([[wrapper.vm.options[0], wrapper.vm.options[1]]]);

        await wrapper.setProps({ value: [wrapper.vm.options[0], wrapper.vm.options[1]] });
        await wrapper.vm.onContainerClick();
