    ...
    inputswitch: {
        ...
        slider: ({ props }) => ({
            class: [
                ...
                {
                    'bg-gray-200 dark:bg-gray-800 hover:bg-gray-300 hover:dark:bg-gray-700 ': !props.value,
                    'bg-blue-500 before:transform before:translate-x-5': props.value
                }
            ]
        })
    },
    ...
    togglebutton: {
            ...
            class: [
                ...
                },
                {
                    'bg-white dark:bg-gray-900 border-gray-300 dark:border-blue-900/40 text-gray-700 dark:text-white/80 hover:bg-gray-100 dark:hover:bg-gray-800/80 hover:border-gray-300 dark:hover:bg-gray-800/70 hover:text-gray-700 dark:hover:text-white/80':
                        !props.value,
                    'bg-blue-500 border-blue-500 text-white hover:bg-blue-600 hover:border-blue-600': props.value
                },
                { 'opacity-60 select-none pointer-events-none cursor-default': props.disabled }
            ]
        }),
        ...
        icon: ({ props }) => ({
            class: [
                ' mr-2',
                {
                    'text-gray-600 dark:text-white/70': !props.value,
                    'text-white': props.value
                }
            ]
        })
    },
    ...
    radiobutton: {
        ...
        input: ({ props }) => ({
            class: [
                ...
                {
                    'border-gray-300 bg-white dark:border-blue-900/40 dark:bg-gray-900 dark:text-white/80': props.value !== props.value,
                    'border-blue-500 bg-blue-500 dark:border-blue-400 dark:bg-blue-400': props.value == props.value
                },
                {
                    'hover:border-blue-500 dark:hover:border-blue-400 focus:outline-none focus:outline-offset-0 focus:shadow-[0_0_0_0.2rem_rgba(191,219,254,1)] dark:focus:shadow-[inset_0_0_0_0.2rem_rgba(147,197,253,0.5)]': !props.disabled,
                    'cursor-default opacity-60': props.disabled
        ...
        icon: ({ props }) => ({
            class: [
                ...
                {
                    'backface-hidden scale-10 invisible': props.value !== props.value,
                    'transform scale-100 visible': props.value == props.value
                }
            ]
        })
    },
        ...
        label: ({ props }) => ({
            class: [
                ...
                'p-3 transition duration-200',
                {
                    ...
                    '!p-3': props.display == 'chip' && props?.value == null
                }
            ]
        }),
        token: {
    ...
    dataviewlayoutoptions: {
        listbutton: ({ props }) => ({
            class: [
                ...
                props.value === 'list' ? 'bg-blue-500 border-blue-500 text-white dark:bg-sky-300 dark:border-sky-300 dark:text-gray-900' : 'bg-white border-gray-300 text-blue-gray-700 dark:bg-gray-900 dark:border-blue-900/40 dark:text-white/80' // highlighted state
            ]
        }),
        gridbutton: ({ props }) => ({
            class: [
                ...
                props.value === 'grid' ? 'bg-blue-500 border-blue-500 text-white dark:bg-sky-300 dark:border-sky-300 dark:text-gray-900' : 'bg-white border-gray-300 text-blue-gray-700 dark:bg-gray-900 dark:border-blue-900/40 dark:text-white/80' // highlighted state
            ]
        })
    },
    organizationchart: {
