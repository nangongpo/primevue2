...
import CalendarIcon from 'primevue2/icons/calendar';
import ChevronDownIcon from 'primevue2/icons/chevrondown';
import ChevronLeftIcon from 'primevue2/icons/chevronleft';
import ChevronRightIcon from 'primevue2/icons/chevronright';
import ChevronUpIcon from 'primevue2/icons/chevronup';
...
export default {
    ...
    inheritAttrs: false,
    emits: ['show', 'hide', 'input', 'month-change', 'year-change', 'date-select', 'input', 'today-click', 'clear-click', 'focus', 'blur', 'keydown'],
