...
export default {
    ...
    computed: {
        ...
        ariaValueLabel() {
            return this.value ? this.$primevue.config.locale.aria.trueLabel : this.value === false ? this.$primevue.config.locale.aria.falseLabel : this.$primevue.config.locale.aria.nullLabel;
        }
    },
    components: {
        CheckIcon,
