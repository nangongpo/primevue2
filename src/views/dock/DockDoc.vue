    ...
    data() {
        return {
            items: [
                {
                    label: 'Finder',
                    icon: () => &lt;img alt="Finder" src={$publicUrl('demo/images/dock/finder.svg')} style="width: 100%" /&gt;
                },
                {
                    label: 'App Store',
                    icon: () => &lt;img alt="App Store" src={$publicUrl('demo/images/dock/appstore.svg')} style="width: 100%" /&gt;
                },
                {
                    label: 'Photos',
                    icon: () => &lt;img alt="Photos" src={$publicUrl('demo/images/dock/photos.svg')} style="width: 100%" /&gt;
                },
                {
                    label: 'Trash',
                    icon: () => &lt;img alt="trash" src={$publicUrl('demo/images/dock/trash.png')} style="width: 100%" /&gt;
                }
            ]
        }
    }
        ...
        <TabPanel header="Source">
            <a href="https://github.com/nangongpo/primevue2/tree/main/src/views/dock" class="btn-viewsource" target="_blank" rel="noopener noreferrer">
    ...
    data() {
        return {
            ...
            dockItems: [
                ...
                {
                    label: 'Terminal',
                    icon: getPublicUrl("demo/images/dock/terminal.svg"),
                    command: () => {
                ...
                {
                    label: 'Safari',
                    icon: getPublicUrl("demo/images/dock/safari.svg"),
                    command: () => {
                ...
                {
                    label: 'GitHub',
                    icon: getPublicUrl("demo/images/dock/github.svg"),
                },
                {
                    label: 'Trash',
