...
&lt;OrganizationChart :value="data"&gt;
    &lt;template #person="slotProps"&gt;
        ...
        &lt;div class="node-content"&gt;
            &lt;img :src="$publicUrl('demo/images/organization/' + slotProps.node.data.avatar)" width="32"&gt;
    ...
    data() {
        return {
			...
			<TabPanel header="Source">
				<a href="https://github.com/nangongpo/primevue2/tree/main/src/views/organizationchart" class="btn-viewsource" target="_blank" rel="noopener noreferrer">
