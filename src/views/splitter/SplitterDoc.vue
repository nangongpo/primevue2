...
&lt;/Splitter&gt;
			...
			<TabPanel header="Source">
				<a href="https://github.com/nangongpo/primevue2/tree/main/src/views/splitter" class="btn-viewsource" target="_blank" rel="noopener noreferrer">
