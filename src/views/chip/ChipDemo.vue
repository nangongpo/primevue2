    ...
    <div>
        ...
        <div class="content-section implementation">
            <div class="card">
                ...
                <div class="flex align-items-center flex-column sm:flex-row">
                    <Chip label="Amy Elsner" :image="$publicUrl('demo/images/avatar/amyelsner.png')" class="mr-2 mb-2"></Chip>
                    <Chip label="Asiya Javayant" :image="$publicUrl('demo/images/avatar/asiyajavayant.png')" class="mr-2 mb-2"></Chip>
                    <Chip label="Onyama Limba" :image="$publicUrl('demo/images/avatar/onyamalimba.png')" class="mr-2 mb-2"></Chip>
                    <Chip label="Xuxue Feng" :image="$publicUrl('demo/images/avatar/xuxuefeng.png')" :removable="true" class="mb-2"></Chip>
                </div>
                ...
                <div class="flex align-items-center flex-column sm:flex-row">
                    ...
                    <Chip label="Onyama Limba" :image="$publicUrl('demo/images/avatar/onyamalimba.png')" class="mr-2 mb-2 custom-chip"></Chip>
                    <Chip label="Xuxue Feng" :image="$publicUrl('demo/images/avatar/xuxuefeng.png')" :removable="true" class="mb-2 custom-chip"></Chip>
                </div>
            </div>
        </div>
