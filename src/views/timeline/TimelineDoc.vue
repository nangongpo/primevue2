...
&lt;Timeline :value="events" align="alternate" class="customized-timeline"&gt;
	...
	&lt;template #content="slotProps"&gt;
		&lt;Card&gt;
			...
			&lt;/template&gt;
			&lt;template #content&gt;
				&lt;img v-if="slotProps.item.image" :src="$publicUrl('demo/images/product/' + slotProps.item.image)" :alt="slotProps.item.name" width="200" class="shadow-2" /&gt;
...
&lt;/Timeline&gt;
			...
			<TabPanel header="Source">
				<a href="https://github.com/nangongpo/primevue2/tree/main/src/views/timeline" class="btn-viewsource" target="_blank" rel="noopener noreferrer">
