...
&lt;OverlayPanel ref="op"&gt;
	&lt;img :src="$publicUrl('demo/images/nature/nature1.jpg')" alt="Nature Image"&gt;
&lt;/OverlayPanel&gt;
</CodeHighlight>
...
&lt;/OverlayPanel&gt;
			...
			<TabPanel header="Source">
				<a href="https://github.com/nangongpo/primevue2/tree/main/src/views/overlaypanel" class="btn-viewsource" target="_blank" rel="noopener noreferrer">
