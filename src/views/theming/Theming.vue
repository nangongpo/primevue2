    ...
    <div>
        <div class="content-section documentation">
            ...
            <p>CSS of the themes share the same license as PrimeVue which is MIT, this means the generated CSS can be customized per your needs however this should be avoided if your customizations
                ...
                by changing a single variable e.g. $primaryColor. Visit the <a href="https://www.primefaces.org/designer/api/primevue2/2.0.0">SASS API</a> for the documentation of available customization options.</p>
