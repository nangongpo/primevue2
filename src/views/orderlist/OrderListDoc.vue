...
&lt;OrderList v-model="cars" listStyle="height:auto" dataKey="vin"&gt;
    ...
    &lt;template #item="slotProps"&gt;
        &lt;div class="p-caritem"&gt;
            &lt;img :src="$publicUrl('demo/images/car/' + slotProps.item.brand + '.png')"&gt;
            &lt;div&gt;
...
&lt;/OrderList&gt;
			...
			<TabPanel header="Source">
				<a href="https://github.com/nangongpo/primevue2/tree/main/src/views/orderlist" class="btn-viewsource" target="_blank" rel="noopener noreferrer">
