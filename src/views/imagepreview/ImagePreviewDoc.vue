...
&lt;/ImagePreview&gt;
            ...
            <TabPanel header="Source">
                <a href="https://github.com/nangongpo/primevue2/tree/main/src/views/imagepreview" class="btn-viewsource" target="_blank" rel="noopener noreferrer">
					<span>View on GitHub</span>
				</a>
<CodeHighlight>
<template v-pre>
&lt;h5&gt;Basic&lt;/h5&gt;
&lt;ImagePreview :src="$publicUrl('demo/images/galleria/galleria1.jpg')" alt="Image" width="250" /&gt;

&lt;h5&gt;Preview&lt;/h5&gt;
&lt;ImagePreview :src="$publicUrl('demo/images/galleria/galleria11.jpg')" alt="Image" width="250" preview /&gt;
</template>
</CodeHighlight>
            </TabPanel>
        </TabView>
