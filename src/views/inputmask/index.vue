  ...
  <div>
    <div class="content-section introduction">
      <div class="feature-intro">
        <h1>InputMask</h1>
        <p>
          InputMask component is used to enter input in a certain format such as numeric, date, currency, email and
          phone.
        </p>
      </div>
      <AppInputStyleSwitch />
...
<script>
import InputMaskDoc from '@/doc/inputmask/index.vue'
