    ...
    <div class="content-section introduction">
      <div class="feature-intro">
        ...
        <p>
          ...
          storage so that when the page is visited again, table would render the data using its last settings.
        </p>
      </div>
    </div>
    ...
    <div class="content-section implementation">
      <div class="card">
        ...
        <DataTable
          ...
          :selection.sync="selectedCustomer1"
      ...
      <div class="card">
        ...
        <DataTable
          ...
          <Column
            ...
            <template #filter>
              <MultiSelect
                v-model="filters2['representative.name']"
                :options="representatives"
                optionLabel="name"
                optionValue="name"
                placeholder="All"
