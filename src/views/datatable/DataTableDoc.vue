...
&lt;DataTable :value="cars"&gt;
    ...
    &lt;Column field="brand" header="Brand"&gt;
        &lt;template #body="slotProps"&gt;
            &lt;img :src="$publicUrl('demo/images/car/' + slotProps.data.brand + '.png')" :alt="slotProps.data.brand"  width="48px"/&gt;
        &lt;/template&gt;
    &lt;/Column&gt;
    &lt;Column field="color" header="Color"&gt;&lt;/Column&gt;
...
&lt;DataTable :value="cars" :expandedRows.sync="expandedRows" dataKey="vin"
    ...
    &lt;template #expansion="slotProps"&gt;
        &lt;div class="car-details"&gt;
            &lt;div&gt;
                &lt;img :src="$publicUrl('demo/images/car/' + slotProps.data.brand + '.png')" :alt="slotProps.data.brand"/&gt;
                &lt;div class="grid"&gt;
            ...
            &lt;Dropdown v-model="slotProps.data['brand']" :options="brands" optionLabel="brand" optionValue="value" placeholder="Select a Brand"&gt;
                &lt;template #option="optionProps"&gt;
                    &lt;div class="p-dropdown-car-option"&gt;
                        &lt;img :alt="optionProps.option.brand" :src="$publicUrl('demo/images/car/' + optionProps.option.brand + '.png')" /&gt;
        ...
        &lt;template #filter&gt;
            &lt;Dropdown v-model="filters['brand']" :options="brands" optionLabel="brand" optionValue="value" placeholder="Select a Brand" class="p-column-filter" :showClear="true"&gt;
                &lt;template #option="slotProps"&gt;
                    &lt;div class="p-dropdown-car-option"&gt;
                        &lt;img :alt="slotProps.option.brand" :src="$publicUrl('demo/images/car/' + slotProps.option.brand + '.png')" /&gt;
...
.orange-car {
    ...
    color: #ffffff !important;
            ...
            <TabPanel header="Source">
				<a href="https://github.com/nangongpo/primevue2/tree/main/src/views/datatabledemo" class="btn-viewsource" target="_blank" rel="noopener noreferrer">
...
&lt;DataTable :value="customers" :paginator="true" class="p-datatable-customers" :rows="10"
    ...
    &lt;Column header="Agent" sortable filterField="representative" sortField="representative.name" :showFilterMatchModes="false" :filterMenuStyle="{'width':'14rem'}" :styles="{'min-width': '14rem'}"&gt;
        &lt;template #body="{data}"&gt;
            &lt;img :alt="data.representative.name" :src="$publicUrl('demo/images/avatar/' + data.representative.image)" width="32" style="vertical-align: middle" /&gt;
            ...
            &lt;MultiSelect v-model="filterModel.value" :options="representatives" optionLabel="name" placeholder="Any" class="p-column-filter"&gt;
                &lt;template #option="slotProps"&gt;
                    &lt;div class="p-multiselect-representative-option"&gt;
                        &lt;img :alt="slotProps.option.name" :src="$publicUrl('demo/images/avatar/' + slotProps.option.image)" width="32" style="vertical-align: middle" /&gt;
