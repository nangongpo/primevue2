  ...
  <div>
    <div class="content-section introduction">
      <div class="feature-intro">
        ...
        <p>
          Columns can be grouped at header and footer using headerColumnGroup
          and footerColumnGroup components.
        </p>
      </div>
    </div>
    ...
    <DataTableColGroupDoc />
  </div>
</template>

<script>
import DataTableColGroupDoc from '@/doc/datatable/ColGroup.vue'
export default {
  components: { DataTableColGroupDoc },
  data() {
    return {
      sales: null
    }
