<template>
    <div>
        <div class="content-section documentation">
            <Message severity="warn">This guide is for Vue 2 and PrimeVue 2, visit <a href="https://www.primefaces.org/primevue2/showcase/">PrimeVue 3.x website</a> if you are using Vue 3.</Message>
