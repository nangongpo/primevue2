<template>
    <div>
        <div class="content-section documentation">
            <Message severity="warn">This guide is for Vue 2 and PrimeVue 2, visit <a href="https://v3.primevue.org">PrimeVue 3.x website</a> if you are using Vue 3.</Message>
            ...
            <p>PrimeVue has a built-in nuxt module. Open <strong>nuxt.config.js</strong> and add <i>primevue2/nuxt</i> to the modules section along with your configuration.</p>
