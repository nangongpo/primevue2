...
&lt;Dropdown v-model="selectedCar" :options="cars" optionLabel="brand" :filter="true" placeholder="Select a Car" :showClear="true"&gt;
	&lt;template #value="slotProps"&gt;
        &lt;div class="p-dropdown-car-value" v-if="slotProps.value"&gt;
            &lt;img :alt="slotProps.value.brand" :src="$publicUrl('demo/images/car/' + slotProps.value.brand + '.png')" /&gt;
...
&lt;/Dropdown&gt;
			...
			<TabPanel header="Source">
				<a href="https://github.com/nangongpo/primevue2/tree/main/src/views/dropdown" class="btn-viewsource" target="_blank" rel="noopener noreferrer">
