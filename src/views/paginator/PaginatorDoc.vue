...
onPage(event) {
    ...
    //event.pageCount: Total number of pages
            ...
            <TabPanel header="Source">
                <a href="https://github.com/primefaces/primevue2/tree/2.x/src/showcase/paginator" class="btn-viewsource" target="_blank" rel="noopener noreferrer">
...
&lt;div class="image-gallery"&gt;
    &lt;img :src="$publicUrl('demo/images/nature/' + image + '.jpg')" /&gt;
&lt;/div&gt;
</CodeHighlight>
