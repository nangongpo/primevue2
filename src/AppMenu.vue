<template>
    <div :class="['layout-sidebar', {'active': active}]">
        <div class="layout-menu">
            ...
            <div class="menu-items">
                <router-link to="/datatable" custom v-slot="{ isActive }">
                    <div>
                ...
                <router-link to="/tree" custom v-slot="{ isActive }">
                    <div>
                ...
                <router-link to="/treetable" custom v-slot="{ isActive }">
                    <div>
            ...
            <div class="menu-items">
                ...
                <router-link to="/galleria" custom v-slot="{ isActive }">
                    <div>
...
export default {
  ...
  methods: {
    ...
    isSubmenuActive(name, routerIsActive) {
      if (Object.hasOwnProperty.call(this.activeSubmenus, name)) {
