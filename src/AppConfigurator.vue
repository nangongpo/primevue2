                    ...
                    <div class="grid free-themes">
                        <div class="col-3">
                            <button class="p-link" type="button" @click="changeTheme($event, 'bootstrap4-light-blue')">
                                <img :src="$publicUrl('demo/images/themes/bootstrap4-light-blue.svg')" alt="Bootstrap Light Blue" />
                            </button>
                            <span>Blue</span>
                        </div>
                        <div class="col-3">
                            <button class="p-link" type="button" @click="changeTheme($event, 'bootstrap4-light-purple')">
                                <img :src="$publicUrl('demo/images/themes/bootstrap4-light-purple.svg')" alt="Bootstrap Light Blue" />
                            </button>
                            <span>Purple</span>
                        </div>
                        <div class="col-3">
                            <button class="p-link" type="button" @click="changeTheme($event, 'bootstrap4-dark-blue', true)">
                                <img :src="$publicUrl('demo/images/themes/bootstrap4-dark-blue.svg')" alt="Bootstrap Dark Blue" />
                            </button>
                            <span>Blue</span>
                        </div>
                        <div class="col-3">
                            <button class="p-link" type="button" @click="changeTheme($event, 'bootstrap4-dark-purple', true)">
                                <img :src="$publicUrl('demo/images/themes/bootstrap4-dark-purple.svg')" alt="Bootstrap Dark Blue" />
                            </button>
                            <span>Purple</span>
                        </div>
                    </div>
                    ...
                    <div class="grid free-themes">
                        <div class="col-3">
                            <button class="p-link" type="button" @click="changeTheme($event, 'md-light-indigo')">
                                <img :src="$publicUrl('demo/images/themes/md-light-indigo.svg')" alt="Material Light Indigo" />
                            </button>
                            <span>Indigo</span>
                        </div>
                        <div class="col-3">
                            <button class="p-link" type="button" @click="changeTheme($event, 'md-light-deeppurple')">
                                <img :src="$publicUrl('demo/images/themes/md-light-deeppurple.svg')" alt="Material Light Deep Purple" />
                            </button>
                            <span>Deep Purple</span>
                        </div>
                        <div class="col-3">
                            <button class="p-link" type="button" @click="changeTheme($event, 'md-dark-indigo', true)">
                                <img :src="$publicUrl('demo/images/themes/md-dark-indigo.svg')" alt="Material Dark Indigo" />
                            </button>
                            <span>Indigo</span>
                        </div>
                        <div class="col-3">
                            <button class="p-link" type="button" @click="changeTheme($event, 'md-dark-deeppurple', true)">
                                <img :src="$publicUrl('demo/images/themes/md-dark-deeppurple.svg')" alt="Material Dark Deep Purple" />
                            </button>
                            <span>Deep Purple</span>
                        </div>
                    </div>
                    ...
                    <div class="grid free-themes">
                        <div class="col-3">
                            <button class="p-link" type="button" @click="changeTheme($event, 'mdc-light-indigo')">
                                <img :src="$publicUrl('demo/images/themes/md-light-indigo.svg')" alt="Material Compact Light Indigo"/>
                            </button>
                            <span>Indigo</span>
                        </div>
                        <div class="col-3">
                            <button class="p-link" type="button" @click="changeTheme($event, 'mdc-light-deeppurple')">
                                <img :src="$publicUrl('demo/images/themes/md-light-deeppurple.svg')" alt="Material Compact Deep Purple" />
                            </button>
                            <span>Deep Purple</span>
                        </div>
                        <div class="col-3">
                            <button class="p-link" type="button" @click="changeTheme($event, 'mdc-dark-indigo', true)">
                                <img :src="$publicUrl('demo/images/themes/md-dark-indigo.svg')" alt="Material Compact Dark Indigo" />
                            </button>
                            <span>Indigo</span>
                        </div>
                        <div class="col-3">
                            <button class="p-link" type="button" @click="changeTheme($event, 'mdc-dark-deeppurple', true)">
                                <img :src="$publicUrl('demo/images/themes/md-dark-deeppurple.svg')" alt="Material Compact Dark Deep Purple" />
                            </button>
                            <span>Deep Purple</span>
                        </div>
                    </div>
                    ...
                    <div class="grid free-themes">
                        <div class="col-3">
                            <button class="p-link" type="button" @click="changeTheme($event, 'tailwind-light')">
                                <img :src="$publicUrl('demo/images/themes/tailwind-light.png')" alt="Tailwind Light"/>
                            </button>
                    ...
                    <div class="grid free-themes">
                        <div class="col-3">
                            <button class="p-link" type="button" @click="changeTheme($event, 'fluent-light')">
                                <img :src="$publicUrl('demo/images/themes/fluent-light.png')" alt="Fluent Light"/>
                            </button>
                    ...
                    <div class="grid free-themes">
                        <div class="col-3">
                            <button class="p-link" type="button" @click="changeTheme($event, 'soho-light')">
                                <img :src="$publicUrl('demo/images/themes/soho-light.png')" alt="Soho Light" />
                            </button>
                            <span>Soho Light</span>
                        </div>
                        <div class="col-3">
                            <button class="p-link" type="button" @click="changeTheme($event, 'soho-dark', true)">
                                <img :src="$publicUrl('demo/images/themes/soho-dark.png')" alt="Soho Dark" />
                            </button>
                            <span>Soho Dark</span>
                        </div>
                        <div class="col-3">
                            <button class="p-link" type="button" @click="changeTheme($event, 'viva-light')">
                                <img :src="$publicUrl('demo/images/themes/viva-light.svg')" alt="Viva Light" />
                            </button>
                            <span>Viva Light</span>
                        </div>
                        <div class="col-3">
                            <button class="p-link" type="button" @click="changeTheme($event, 'viva-dark', true)">
                                <img :src="$publicUrl('demo/images/themes/viva-dark.svg')" alt="Viva Dark" />
                            </button>
                            <span>Viva Dark</span>
                        </div>
                        <div class="col-3">
                            <button class="p-link" type="button" @click="changeTheme($event, 'mira')">
                                <img :src="$publicUrl('demo/images/themes/mira.jpg')" alt="Mira" />
                            </button>
                            <span>Mira</span>
                        </div>
                        <div class="col-3">
                            <button class="p-link" type="button" @click="changeTheme($event, 'nano')">
                                <img :src="$publicUrl('demo/images/themes/nano.jpg')" alt="Mira" />
                            </button>
                            <span>Nano</span>
                        </div>
                    </div>
