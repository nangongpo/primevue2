<template>
  <div>
    ...
    <p>Icons and Labels can be customized using <i>onLabel</i>, <i>offLabel</i>, <i>onIcon</i> and <i>offIcon</i>
      properties.</p>
    <DocSectionCode :code="labelsAndIconsCode" />
      ...
      <table class="doc-table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>string</td>
            <td>null</td>
            <td>Establishes relationships between the component and label(s) where its value should be one or more
              element IDs.</td>
          </tr>
        </tbody>
      </table>
