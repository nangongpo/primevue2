<template>
  <div>
    <a
      href="https://github.com/nangongpo/primevue2/tree/main/src/views/breadcrumb"
      class="btn-viewsource"
      target="_blank"
      rel="noopener noreferrer">
      <span>View on GitHub</span>
    </a>
    <DocSectionCode :code="sourceCode1" importCode />
    <DocSectionCode :code="sourceCode2" />
    <DocSectionCode :code="sourceCode3" importCode />
    <DocSectionCode :code="sourceCode4" importStyle />
  </div>
</template>
