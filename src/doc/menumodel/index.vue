<template>
  <div>
    <div class="content-section documentation">
      ...
      <h5>MenuItem</h5>
      <p>
        Core of the API is the MenuItem class that defines various options such as the label, icon and children of an
        item in a menu.
      </p>

      <DocSectionCode :code="menuItemCode" importCode />

      <p>
        MenuItem provides the following properties. Note that not all of them may be utilized by the corresponding menu
        component.
      </p>
      ...
      <DocSectionCode :code="commandCode" importCode />

      <h5>Navigation</h5>
      <p>
        Navigation is specified using <i>url</i> property for external links or using <i>to</i> property for internal
        routing.
      </p>
      <DocSectionCode :code="navigationCode" importCode />

      <h5>Visibility</h5>
      <p>
        It is a common case to hide certain items based on conditions such as user roles, <i>visible</i> property is
        available to implement such cases by supporting functions that returns booleans or simple booleans.
      </p>
      <DocSectionCode :code="visibilityCode" importCode />
    </div>
  </div>
</template>
