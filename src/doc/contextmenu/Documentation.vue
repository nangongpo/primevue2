<template>
  <div>
    ...
    <DocSectionCode :code="documentMenuCode" />

    <h5>Element Menu</h5>
    <p>
      ContextMenu is attached to a custom element manually using the reference and calling the
      <i>show(event)</i> method.
    </p>
    <DocSectionCode :code="elementMenuCode" />
    <DocSectionCode :code="elementMenuCode2" importCode />
