<template>
  <div>
    ...
    <h5>Lazy</h5>
    <p>Lazy Loading is handy to deal with huge datasets. Idea is instead of loading the whole tree, load child nodes on
      demand
      using expand expand. The important part is setting <i>leaf</i> to true on a node instance so that even without
      children,
    ...
    <h5>Templating</h5>
    <p>The <i>type</i> property of a TreeNode is used to map a template to a node to create the node label. If it is
      undefined and no default template is available,
    ...
    <p>Filtering is enabled by setting the <i>filter</i> property to true, by default label property of a node
      is used to compare against the value in the text field, in order to customize which field(s) should be used during
      search, define the <i>filterBy</i> property as a comma separated list.</p>
    ...
    <p>In addition <i>filterMode</i> specifies the filtering strategy. In <b>lenient</b> mode when the query matches a
      ...
      hand,
      in <b>strict</b> mode when the query matches a node, filtering continues on all descendants.</p>Z
      ...
      <table class="doc-table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>string</td>
            <td>label</td>
            <td>When filtering is enabled, filterBy decides which field or fields (comma separated) to search against.
            </td>
          </tr>
          <tr>
            <td>filterMode</td>
            ...
            nodes: [
                {
                    ...
                    label: 'Introduction',
                    children: [
                        {key: '0-0', label: 'What is Vue.js?', data:'https://v2.vuejs.org/v2/guide/#What-is-Vue-js', type: 'url'},
                        {key: '0-1', label: 'Getting Started', data: 'https://v2.vuejs.org/v2/guide/#Getting-Started', type: 'url'},
                        {key: '0-2', label: 'Declarative Rendering', data:'https://v2.vuejs.org/v2/guide/#Declarative-Rendering', type: 'url'},
                        {key: '0-3', label: 'Conditionals and Loops', data: 'https://v2.vuejs.org/v2/guide/#Conditionals-and-Loops', type: 'url'}
                    ]
                },
                {
                    key: '1',
                    ...
                    children: [
                        {key: '1-0', label: 'Component Registration', data: 'https://v2.vuejs.org/v2/guide/components-registration.html', type: 'url'},
                        {key: '1-1', llabel: 'Props', data: 'https://v2.vuejs.org/v2/guide/components-props.html', type: 'url'},
                        {key: '1-2', llabel: 'Custom Events', data: 'https://v2.vuejs.org/v2/guide/components-custom-events.html', type: 'url'},
                        {key: '1-3', llabel: 'Slots', data: 'https://v2.vuejs.org/v2/guide/components-slots.html', type: 'url'}
                    ]
                }
            ]
        }
