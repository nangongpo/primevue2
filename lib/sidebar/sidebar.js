...
this.primevue2.sidebar = (function (utils, Ripple) {
  'use strict';
  ...
  var script = {
    ...
    methods: {
      ...
      focus: function focus() {
        var focusable = utils.DomHandler.findSingle(this.$refs.container, 'input,button');
        if (focusable) {
          focusable.focus();
        }
      },
  ...
  var __vue_inject_styles__ = function __vue_inject_styles__(inject) {
    ...
    inject("data-v-70ed9bb2_0", {
      ...
      map: {
        "version": 3,
        "sources": ["/Users/nangongpo/Desktop/我的开源/primevue2/src/components/sidebar/Sidebar.vue"],
        "names": [],
