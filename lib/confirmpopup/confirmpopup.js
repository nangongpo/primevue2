...
this.primevue2.confirmpopup = (function (ConfirmationEventBus, Button, utils) {
  'use strict';
    ...
    methods: {
      ...
      alignOverlay: function alignOverlay() {
        ...
        if (containerOffset.top < targetOffset.top) {
          utils.DomHandler.addClass(this.$refs.container, 'p-confirm-popup-flipped');
        }
      },
  ...
  var __vue_inject_styles__ = function __vue_inject_styles__(inject) {
    ...
    inject("data-v-1c98e9a8_0", {
      ...
      map: {
        "version": 3,
        "sources": ["/Users/nangongpo/Desktop/开源学习/primevue2/src/components/confirmpopup/ConfirmPopup.vue"],
        "names": [],
...
})(primevue2.confirmationeventbus, primevue2.button, primevue2.utils);
