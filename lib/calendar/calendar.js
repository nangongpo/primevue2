...
this.primevue2.calendar = (function (utils, InputText, Button, Ripple) {
  'use strict';
  ...
  var script = {
    ...
    mounted: function mounted() {
      ...
      if (this.inline) {
        ...
        if (!this.$attrs.disabled) {
          ...
          this.$refs.overlay.style.width = utils.DomHandler.getOuterWidth(this.$el) + 'px';
        }
      }
    },
    ...
    methods: {
      ...
      onOverlayEnter: function onOverlayEnter(el) {
        ...
        if (this.autoZIndex) {
          this.$refs.overlay.style.zIndex = String(this.baseZIndex + utils.DomHandler.generateZIndex());
        }
      ...
      isNavIconClicked: function isNavIconClicked(event) {
        return utils.DomHandler.hasClass(event.target, 'p-datepicker-prev') || utils.DomHandler.hasClass(event.target, 'p-datepicker-prev-icon') || utils.DomHandler.hasClass(event.target, 'p-datepicker-next') || utils.DomHandler.hasClass(event.target, 'p-datepicker-next-icon');
      },
      alignOverlay: function alignOverlay() {
        if (this.touchUI) {
          this.enableModality();
        } else if (this.$refs.overlay) {
          if (this.appendTo) utils.DomHandler.absolutePosition(this.$refs.overlay, this.$el);else utils.DomHandler.relativePosition(this.$refs.overlay, this.$el);
        }
      },
      ...
      onDateSelect: function onDateSelect(event, dateMeta) {
        ...
        utils.DomHandler.find(this.$refs.overlay, '.p-datepicker-calendar td span:not(.p-disabled)').forEach(function (cell) {
      ...
      navigateToMonth: function navigateToMonth(prev, groupIndex) {
        if (prev) {
          if (this.numberOfMonths === 1 || groupIndex === 0) {
            ...
            var cells = utils.DomHandler.find(prevMonthContainer, '.p-datepicker-calendar td span:not(.p-disabled):not(.p-ink)');
          ...
          if (this.numberOfMonths === 1 || groupIndex === this.numberOfMonths - 1) {
            ...
            var _focusCell4 = utils.DomHandler.findSingle(nextMonthContainer, '.p-datepicker-calendar td span:not(.p-disabled):not(.p-ink)');
      ...
      updateFocus: function updateFocus() {
        ...
        if (this.navigationState) {
          if (this.navigationState.button) {
            this.initFocusableCell();
            if (this.navigationState.backward) utils.DomHandler.findSingle(this.$refs.overlay, '.p-datepicker-prev').focus();else utils.DomHandler.findSingle(this.$refs.overlay, '.p-datepicker-next').focus();
          } else {
            if (this.navigationState.backward) {
              var cells;
              if (this.currentView === 'month') {
                cells = utils.DomHandler.find(this.$refs.overlay, '.p-monthpicker .p-monthpicker-month:not(.p-disabled)');
              } else if (this.currentView === 'year') {
                cells = utils.DomHandler.find(this.$refs.overlay, '.p-yearpicker .p-yearpicker-year:not(.p-disabled)');
              } else {
                cells = utils.DomHandler.find(this.$refs.overlay, '.p-datepicker-calendar td span:not(.p-disabled):not(.p-ink)');
              }
              ...
              if (this.currentView === 'month') {
                cell = utils.DomHandler.findSingle(this.$refs.overlay, '.p-monthpicker .p-monthpicker-month:not(.p-disabled)');
              } else if (this.currentView === 'year') {
                cell = utils.DomHandler.findSingle(this.$refs.overlay, '.p-yearpicker .p-yearpicker-year:not(.p-disabled)');
              } else {
                cell = utils.DomHandler.findSingle(this.$refs.overlay, '.p-datepicker-calendar td span:not(.p-disabled):not(.p-ink)');
              }
            }
            if (cell) {
              cell.tabIndex = '0';
      ...
      initFocusableCell: function initFocusableCell() {
        var cell;
        if (this.currentView === 'month') {
          var cells = utils.DomHandler.find(this.$refs.overlay, '.p-monthpicker .p-monthpicker-month');
          var selectedCell = utils.DomHandler.findSingle(this.$refs.overlay, '.p-monthpicker .p-monthpicker-month.p-highlight');
          cells.forEach(function (cell) {
            return cell.tabIndex = -1;
          });
          cell = selectedCell || cells[0];
        } else if (this.currentView === 'year') {
          var _cells = utils.DomHandler.find(this.$refs.overlay, '.p-yearpicker .p-yearpicker-year');
          var _selectedCell = utils.DomHandler.findSingle(this.$refs.overlay, '.p-yearpicker .p-yearpicker-year.p-highlight');
          ...
          if (this.$refs.overlay) {
            cell = utils.DomHandler.findSingle(this.$refs.overlay, 'span.p-highlight');
            if (!cell) {
              var todayCell = utils.DomHandler.findSingle(this.$refs.overlay, 'td.p-datepicker-today span:not(.p-disabled):not(.p-ink)');
              if (todayCell) cell = todayCell;else cell = utils.DomHandler.findSingle(this.$refs.overlay, '.p-datepicker-calendar td span:not(.p-disabled):not(.p-ink');
            }
          }
        }
        if (cell) {
      ...
      trapFocus: function trapFocus(event) {
        event.preventDefault();
        var focusableElements = utils.DomHandler.getFocusableElements(this.$refs.overlay);
        ...
        return _objectSpread(_objectSpread({}, $vm.$listeners), {}, {
          ...
          keydown: function keydown(event) {
            ...
            if (event.keyCode === 40 && $vm.$refs.overlay) {
              ...
              if ($vm.showOnFocus) {
                utils.DomHandler.getFocusableElements($vm.$refs.overlay).forEach(function (el) {
  ...
  var __vue_inject_styles__ = function __vue_inject_styles__(inject) {
    ...
    inject("data-v-fbebe2ca_0", {
      ...
      map: {
        "version": 3,
        "sources": ["/Users/nangongpo/Desktop/开源学习/primevue2/src/components/calendar/Calendar.vue"],
        "names": [],
...
})(primevue2.utils, primevue2.inputtext, primevue2.button, primevue2.ripple);
