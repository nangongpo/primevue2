  ...
  methods: {
    ...
    onOptionSelect: function onOptionSelect(event, option) {
      ...
      if (selected) value = this.value.filter(function (val) {
        return !ObjectUtils.equals(val, _this.getOptionValue(option), _this.equalityKey);
    ...
    findNextItem: function findNextItem(item) {
      ...
      if (nextItem) return DomHandler.hasClass(nextItem, 'p-disabled') ? this.findNextItem(nextItem) : nextItem;else return null;
    },
    findPrevItem: function findPrevItem(item) {
      var prevItem = item.previousElementSibling;
      if (prevItem) return DomHandler.hasClass(prevItem, 'p-disabled') ? this.findPrevItem(prevItem) : prevItem;else return null;
    },
    ...
    bindResizeListener: function bindResizeListener() {
      ...
      if (!this.resizeListener) {
        this.resizeListener = function () {
          if (_this4.overlayVisible && !DomHandler.isAndroid()) {
            _this4.hide();
          }
        };
    ...
    removeChip: function removeChip(item) {
      ...
      var value = this.value.filter(function (val) {
        return !ObjectUtils.equals(val, item, _this6.equalityKey);
      });
      this.$emit('input', value);
      this.$emit('change', {
        originalEvent: event,
...
var __vue_inject_styles__ = function __vue_inject_styles__(inject) {
  ...
  inject("data-v-1b689f3e_0", {
    ...
    map: {
      "version": 3,
      "sources": ["/Users/nangongpo/Desktop/开源学习/primevue2/src/components/multiselect/MultiSelect.vue"],
      "names": [],
