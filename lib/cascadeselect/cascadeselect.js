...
this.primevue2.cascadeselect = (function (utils, Ripple) {
  'use strict';
  ...
  var script = {
    ...
    methods: {
      ...
      alignOverlay: function alignOverlay() {
        if (this.appendTo) {
          utils.DomHandler.absolutePosition(this.$refs.overlay, this.$el);
          this.$refs.overlay.style.minWidth = utils.DomHandler.getOuterWidth(this.$el) + 'px';
        } else {
          utils.DomHandler.relativePosition(this.$refs.overlay, this.$el);
        }
      },
        ...
        switch (event.key) {
          ...
          case 'ArrowDown':
            if (this.overlayVisible) {
              utils.DomHandler.findSingle(this.$refs.overlay, '.p-cascadeselect-item').children[0].focus();
  ...
  var __vue_inject_styles__ = function __vue_inject_styles__(inject) {
    ...
    inject("data-v-52ca6338_0", {
      ...
      map: {
        "version": 3,
        "sources": ["/Users/nangongpo/Desktop/我的开源/primevue2/src/components/cascadeselect/CascadeSelect.vue"],
        "names": [],
