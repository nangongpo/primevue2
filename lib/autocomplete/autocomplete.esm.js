...
var script = {
  ...
  methods: {
    ...
    alignOverlay: function alignOverlay() {
      ...
      if (this.appendTo) DomHandler.absolutePosition(this.$refs.overlay, target);else DomHandler.relativePosition(this.$refs.overlay, target);
    },
    ...
    onKeyDown: function onKeyDown(event) {
      if (this.overlayVisible) {
        var highlightItem = DomHandler.findSingle(this.$refs.overlay, 'li.p-highlight');
        switch (event.which) {
          //down
          case 40:
            if (highlightItem) {
        ...
        if (this.suggestions) {
          ...
          try {
            for (_iterator.s(); !(_step = _iterator.n()).done;) {
              ...
              var itemValue = this.field ? ObjectUtils.resolveFieldData(item, this.field) : item;
    ...
    inputValue: function inputValue() {
      if (this.value) {
        if (this.field && _typeof(this.value) === 'object') {
          var resolvedFieldData = ObjectUtils.resolveFieldData(this.value, this.field);
...
var __vue_inject_styles__ = function __vue_inject_styles__(inject) {
  ...
  inject("data-v-772cde54_0", {
    ...
    map: {
      "version": 3,
      "sources": ["/Users/nangongpo/Desktop/开源学习/primevue2/src/components/autocomplete/AutoComplete.vue"],
      "names": [],
