...
this.primevue2.toast = (function (ToastEventBus, Ripple, utils) {
  'use strict';
  ...
  var script = {
    ...
    mounted: function mounted() {
      var _this = this;
      ToastEventBus__default["default"].on('add', function (message) {
        if (_this.group == message.group) {
          _this.add(message);
        }
      });
      ToastEventBus__default["default"].on('remove-group', function (group) {
        if (_this.group === group) {
          _this.messages = [];
        }
      });
      ToastEventBus__default["default"].on('remove-all-groups', function () {
        _this.messages = [];
      });
      this.updateZIndex();
      if (this.breakpoints) {
  ...
  var __vue_inject_styles__ = function __vue_inject_styles__(inject) {
    ...
    inject("data-v-6c31fa3a_0", {
      ...
      map: {
        "version": 3,
        "sources": ["/Users/nangongpo/Desktop/我的开源/primevue2/src/components/toast/Toast.vue"],
        "names": [],
...
})(primevue2.toasteventbus, primevue2.ripple, primevue2.utils);
