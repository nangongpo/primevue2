...
var script = {
  ...
  mounted: function mounted() {
    if (this.type !== 'linear') {
      var button = DomHandler.findSingle(this.$refs.container, '.p-speeddial-button');
      var firstItem = DomHandler.findSingle(this.$refs.list, '.p-speeddial-item');
      if (button && firstItem) {
...
var __vue_inject_styles__ = function __vue_inject_styles__(inject) {
  ...
  inject("data-v-2284f453_0", {
    ...
    map: {
      "version": 3,
      "sources": ["/Users/nangongpo/Desktop/开源学习/primevue2/src/components/speeddial/SpeedDial.vue"],
      "names": [],
