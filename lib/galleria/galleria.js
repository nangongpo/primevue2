...
this.primevue2.galleria = (function (utils, Ripple) {
  'use strict';
  ...
  var script = {
    ...
    methods: {
      onEnter: function onEnter() {
        this.$refs.mask.style.zIndex = String(this.baseZIndex + utils.DomHandler.generateZIndex());
      ...
      onAppear: function onAppear() {
        ...
        if (this.visible) {
          this.onEnter();
          setTimeout(function () {
            utils.DomHandler.addClass(_this.$refs.mask, 'p-component-overlay');
          }, 1);
        }
      },
  ...
  var __vue_inject_styles__ = function __vue_inject_styles__(inject) {
    ...
    inject("data-v-1685fe97_0", {
      ...
      map: {
        "version": 3,
        "sources": ["/Users/nangongpo/Desktop/开源学习/primevue2/src/components/galleria/Galleria.vue"],
        "names": [],
